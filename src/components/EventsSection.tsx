          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#f0f4ff] rounded-[40px] p-8 md:p-12">
              ...
              <div className="flex items-center gap-6">
                <button className="flex items-center gap-2 text-sm font-bold text-secondary/40 hover:text-secondary transition-colors cursor-pointer group">
                  <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />{" "}
                  {t("prev")}
                </button>
                <button className="flex items-center gap-2 text-sm font-bold text-secondary cursor-pointer group">
                  {t("next")}{" "}
